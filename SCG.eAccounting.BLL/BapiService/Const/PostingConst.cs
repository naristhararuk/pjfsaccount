...
namespace SCG.eAccounting.SAP.BAPI.Service.Const
{
    public static class PostingConst
    {
        ...
        public static string Pmnttrms
        {
            get { return ParameterServices.Paymentterm; }
        }

        public static string PmnttrmsIC
        {
            get { return ParameterServices.PaymenttermIC; }
        }
        ...
        public static string AcountPBRepOffice = "0000222290";
    }
}
