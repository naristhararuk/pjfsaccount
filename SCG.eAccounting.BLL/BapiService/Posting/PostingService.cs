...
namespace SCG.eAccounting.SAP.BAPI.Service.Posting
{
    public abstract class PostingService
    {
        ...
        protected RfcDestination GetDestination()
        {
            RfcConfigParameters configParameter = new RfcConfigParameters();
            configParameter.Add(RfcConfigParameters.SystemNumber, ParameterServices.BAPI_SAPSYSNR);
            configParameter.Add(RfcConfigParameters.User, ParameterServices.BAPI_SAPUSER);
            configParameter.Add(RfcConfigParameters.Password, ParameterServices.BAPI_SAPPASSWD);
            configParameter.Add(RfcConfigParameters.Language, ParameterServices.BAPI_SAPLANG);
            configParameter.Add(RfcConfigParameters.Client, ParameterServices.BAPI_SAPCLIENT);
            configParameter.Add(RfcConfigParameters.MessageServerHost, ParameterServices.BAPI_MsgServerHost);
            configParameter.Add(RfcConfigParameters.LogonGroup, ParameterServices.BAPI_LogonGroup);
            configParameter.Add(RfcConfigParameters.SystemID, ParameterServices.BAPI_SAPSystemName);
            configParameter.Add(RfcConfigParameters.Name, ParameterServices.BAPI_ALIAS_NAME);

            return RfcDestinationManager.GetDestination(configParameter);
        }

        protected RfcDestination GetDestination(string sapCode)
        {
            Spring.Validation.ValidationErrors errors = new Spring.Validation.ValidationErrors();

            DbSapInstance data = ScgDbQueryProvider.DbSapInstanceQuery.FindByIdentity(sapCode);
            if (data == null)
            {
                errors.AddError("Posting.Error", new Spring.Validation.ErrorMessage("CannotFoundSAPConfiguration"));
                throw new ServiceValidationException(errors);
            }

            RfcConfigParameters configParameter = new RfcConfigParameters();
            configParameter.Add(RfcConfigParameters.SystemNumber, data.SystemNumber);
            configParameter.Add(RfcConfigParameters.User, data.UserName);
            configParameter.Add(RfcConfigParameters.Password, ParameterServices.EnableDecryptPassword ? PasswordEngine.Decrypt(data.Password) : data.Password);
            configParameter.Add(RfcConfigParameters.Language, data.Language);
            configParameter.Add(RfcConfigParameters.Client, data.Client);
            configParameter.Add(RfcConfigParameters.MessageServerHost, data.MsgServerHost);
            configParameter.Add(RfcConfigParameters.LogonGroup, data.LogonGroup);
            configParameter.Add(RfcConfigParameters.SystemID, data.SystemID);
            configParameter.Add(RfcConfigParameters.Name, data.AliasName);
            ...
            ref BAPIACAR09Table ACAR09Table)
        {
            ...
            if (listBAPIACPA09.Count >= 1)
            {
                ...
                ACPA09.Tax_No_3 = listBAPIACPA09[0].TaxNo3;
                ACPA09.Tax_No_4 = listBAPIACPA09[0].TaxNo4;
            }
            ...
            BAPIRET2Table RET2Table)
        {
            ...
            if (isInsert)
            {
                ...
                if (ACPA09.Name != "")
                {
                    ...
                    tmp.TaxNo3 = ACPA09.Tax_No_3;
                    tmp.TaxNo4 = ACPA09.Tax_No_4;
        ...
        public virtual IList<BAPISimulateReturn> BAPISimulate(long DocId, string DocKind)
        {
            ...
            if (IsOpenSimulator())
            {
                SimulateReturn = SimulateWithoutSAP(DocId, DocKind);
            }
            else
            {
                IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
                ...
                SCGDocument document = SCG.eAccounting.Query.ScgeAccountingQueryProvider.SCGDocumentQuery.FindProxyByIdentity(DocId);

                SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_ACC_DOCUMENT_CHECK simulate = new SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_ACC_DOCUMENT_CHECK(GetDestination(document.CompanyID.SapCode));

                for (int i = 0; i < listBAPIACHE09.Count; i++)
                {
                    string strDocId = GetDocumentStatus(listBAPIACHE09[i].DocId, listBAPIACHE09[i].DocSeq, listBAPIACHE09[i].DocKind);
        ...
        public virtual IList<BAPIPostingReturn> BAPIPosting(long DocId, string DocKind)
        {
            ...
            if (IsOpenSimulator())
            {
                PostingReturn = PostingWithoutSAP(DocId, DocKind);
            }
            else
            {
                IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
                ...
                SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_ACC_DOCUMENT_POST_COMMIT check = new SAPProxy_YBAPI_ACC_DOCUMENT_POST_COMMIT(GetDestination(document.CompanyID.SapCode));
            ...
            else if (DocKind == DocumentKind.FixedAdvanceReturn.ToString())
            {
                if (GetDocumentStatus(DocId, DocKind) == "P")
                    fixedAdvanceService.UpdatePostingStatusFixedAdvanceDocument(DocId, "P");
                else if (GetDocumentStatus(DocId, DocKind) == "PP")
                    fixedAdvanceService.UpdatePostingStatusFixedAdvanceDocument(DocId, "PP");
            }
            else
            {
                if (GetDocumentStatus(DocId, DocKind) == "P")
        ...
        public virtual IList<BAPIApproveReturn> BAPIApprove(long DocId, string DocKind, long UserAccountID)
        {
            ...
            if (IsOpenSimulator())
            {
                ApproveReturn = ApproveWithoutSAP(DocId, DocKind);
            }
            else
            {
                IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
                ...
                SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_EFORMID check = new SAPProxy_YBAPI_EFORMID(GetDestination(document.CompanyID.SapCode));
            ...
            else if(DocKind == DocumentKind.FixedAdvanceReturn.ToString()) 
            {
                SCG.eAccounting.BLL.Implement.FixedAdvanceDocumentService fixedAdvanceService = new FixedAdvanceDocumentService();
                if (GetDocumentStatus(DocId, DocKind) == "A")
                    fixedAdvanceService.UpdatePostingStatusFixedAdvanceDocument(DocId, "C");
                else if (GetDocumentStatus(DocId, DocKind) == "P")
                    fixedAdvanceService.UpdatePostingStatusFixedAdvanceDocument(DocId, "P");
            }
            else
        ...
        public virtual IList<BAPIReverseReturn> BAPIReverse(long DocId, string DocKind)
        {
            ...
            if (IsOpenSimulator())
            {
                ReverseReturn = ReverseWithoutSAP(DocId, DocKind);
            }
            else
            {
                IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
                ...
                SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_DOCUMENT_POST_REVERSE reverse = new SAPProxy_YBAPI_DOCUMENT_POST_REVERSE(GetDestination(document.CompanyID.SapCode));
                ...
                for (int i = 0; i < listBAPIACHE09.Count; i++)
                {
                    ...
                    if (strDocId.Equals("P") || strDocId.Equals("A"))
                    {
                        ...
                        string strPstDate = listBAPIACHE09[i].ReverseDate;
                        string strReason = "01";
            ...
            {
                FixedAdvanceDocumentService fixdoc = new FixedAdvanceDocumentService();
                fixdoc.UpdatePostingStatusFixedAdvanceDocument(DocId, "N");
            }
            else
            {
                if (GetDocumentStatus(DocId, DocKind) == "S")
        ...
        protected string BAPIGetFIDoc(string FIDoc, string DocYear, string ComCode)
        {
            ...
            DbCompany company = ScgDbQueryProvider.DbCompanyQuery.getDbCompanyByCompanyCode(ComCode);
            if (company.UseEcc.HasValue && company.UseEcc.Value)
                destination = GetDestination(company.SapCode);
            else
                destination = GetDestination();

            SCG.eAccounting.SAP.BAPI.SAPProxy_YBAPI_GETFIDOC getFiDoc = new SAPProxy_YBAPI_GETFIDOC(destination);
        ...
        public IList<BAPISimulateReturn> SimulateWithoutSAP(long DocId, string DocKind)
        {
            IList<BAPISimulateReturn> SimulateReturn = new List<BAPISimulateReturn>();
            IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
        ...
        public IList<BAPIPostingReturn> PostingWithoutSAP(long DocId, string DocKind)
        {
            IList<BAPIPostingReturn> PostingReturn = new List<BAPIPostingReturn>();
            IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
        ...
        public IList<BAPIApproveReturn> ApproveWithoutSAP(long DocId, string DocKind)
        {
            IList<BAPIApproveReturn> ApproveReturn = new List<BAPIApproveReturn>();
            IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
        ...
        public IList<BAPIReverseReturn> ReverseWithoutSAP(long DocId, string DocKind)
        {
            IList<BAPIReverseReturn> ReverseReturn = new List<BAPIReverseReturn>();
            IList<Bapiache09> listBAPIACHE09 = BapiQueryProvider.Bapiache09Query.FindByDocID(DocId, DocKind);
