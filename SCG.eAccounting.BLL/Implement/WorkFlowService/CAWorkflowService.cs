...
{
    public class CAWorkflowService : GeneralWorkFlowService, ICAWorkflowService
    {
        ...
        public virtual IList<object> GetEditableFieldsForDraft(long workFlowID)
        {
            ...
            {
                editableFieldEnum.Add(CAFieldGroup.All);
                editableFieldEnum.Add(CAFieldGroup.Initiator);

                WorkFlow workFlow = WorkFlowQueryProvider.WorkFlowQuery.FindByIdentity(workFlowID);
                if (string.IsNullOrEmpty(workFlow.Document.DocumentNo))
                    editableFieldEnum.Add(CAFieldGroup.Company);
            }
        ...
        public virtual IList<object> GetVisibleFieldsForDraft(long workFlowID)
        {
            ...
            visibleFieldEnum.Add(CAFieldGroup.All);
            visibleFieldEnum.Add(CAFieldGroup.Company);
            visibleFieldEnum.Add(CAFieldGroup.Initiator);
        ...
        public string OnCancelComplete(long workFlowID, object eventData)
        {
            ...
            return "WithdrawCompleteToCancel";
        }
        #endregion
