...
{
    /// <summary>
    /// A typed collection of BAPIACGL09 elements.
    /// </summary>
    [Serializable]
    public class BAPIACGL09Table : BAPITable//: SAPTable 
    {

        /// <summary>
        /// Returns the element type BAPIACGL09.
        /// </summary>
        /// <returns>The type BAPIACGL09.</returns>
        public override Type GetElementType()
        {
            return (typeof(BAPIACGL09));
        }

        /// <summary>
        /// Creates an empty new row of type BAPIACGL09.
        /// </summary>
        /// <returns>The newBAPIACGL09.</returns>
        ...
        /// </summary>
        public BAPIACGL09 this[int index]
        {
            get
            {
                return ((BAPIACGL09)(List[index]));
            }
            set
            {
                List[index] = value;
        ...
        /// <summary>
        /// Copies the contents of the BAPIACGL09Table to the specified one-dimensional array starting at the specified index in the target array.
        /// </summary>
        /// <param name="array">The one-dimensional destination array.</param>           
        /// <param name="index">The zero-based index in array at which copying begins.</param>           
        public void CopyTo(BAPIACGL09[] array, int index)
        {
        ...
        {
            IRfcTable table = repository.GetTableMetadata("ACCOUNTGL").CreateTable(List.Count);

            for (int i = 0; i < List.Count; i++)
            { 
                table.Append(((BAPIACGL09)List[i]).GetStructure(repository));
            }
