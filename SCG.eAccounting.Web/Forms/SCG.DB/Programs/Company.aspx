        ...
        <tr>
            <td colspan="2">
                                            ...
                                            <asp:FormView ID="ctlCompanyForm" runat="server" DataKeyNames="CompanyID" OnItemCommand="ctlCompanyForm_ItemCommand"
                                                ...
                                                <EditItemTemplate>
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <%# GetProgramMessage("ManageProfile")%>
                                                                <font color="red">
                                                                    <asp:Label ID="Label2" runat="server" Text="*"></asp:Label></font>
                                                                :
                                                            </td>
                                                            <td align="left">
                                                                <asp:DropDownList ID="ctlMileageRateRivition" SkinID="SkCtlDropDownList" runat="server"
                                                                    Width="252px">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                ...
                <ajaxToolkit:ModalPopupExtender ID="ctlCompanyModalPopupExtender" runat="server"
                    ...
                    CancelControlID="lnkDummy" RepositionMode="None" PopupDragHandleControlID="ctlCompanyFormPanelHeader" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                ...
                <ajaxToolkit:ModalPopupExtender ID="ctlLocationFormModalPopupExtender" runat="server"
                    ...
                    CancelControlID="lnkDummy2" RepositionMode="None" PopupDragHandleControlID="ctlLocationFormPanelHeader" />
            </td>
        </tr>
    </table>
</asp:Content>
