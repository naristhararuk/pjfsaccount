<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramsPages.Master" AutoEventWireup="true"
    CodeBehind="CAForm.aspx.cs" Inherits="SCG.eAccounting.Web.Forms.SCG.eAccounting.Programs.CAForm"
    StylesheetTheme="Default" EnableEventValidation="false" EnableTheming="true" %>

<%@ Register Src="~/UserControls/DocumentEditor/CADocumentEditor.ascx" TagName="CADocumentEditor"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="A" runat="server">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <uc1:CADocumentEditor ID="ctlCADocumentEditor" runat="server" />
