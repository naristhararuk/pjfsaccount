    <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FixedAdvanceForm.ascx.cs" 
Inherits="SCG.eAccounting.Web.Forms.SCG.eAccounting.FixedAdvanceForm" EnableTheming="true" %>

<%@ Register src="~/UserControls/DocumentEditor/FixedAdvanceDocumentEditor.ascx" tagname="FixedAdvanceDocumentEditor" tagprefix="uc7" %>
...
<table width="100%">
    <tr>
        <td>
            <uc7:FixedAdvanceDocumentEditor ID="ctlFixedAdvanceDocumentEditor" runat="server" />
