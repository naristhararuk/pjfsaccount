...
{
    public partial class MPAForm : BasePage
    {
        ...
        {
            (ctlMPADocumentEditor as IDocumentEditor).DsNull += NotifyDsNull;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ctlMPADocumentEditor.Initialize(FlagEnum.NewFlag, null);
        ...
        protected void ctlSave_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                this.WorkFlowID = ctlMPADocumentEditor.Save();
        ...
        {
            ctlMPADocumentEditor.RollBackTransaction();
            ctlMPADocumentEditor.Initialize(FlagEnum.NewFlag, null);
        }
        ...
        protected void ctlConfirmPopup_OnNotifyPopup(object sender, PopUpReturnArgs args)
        {
            try
            {
                ...
                {
                    WorkFlowStateEvent workFlowStateEvent = WorkFlowQueryProvider.WorkFlowStateEventQuery.GetSendDraftStateEvent(WorkFlowTypeID.MPAWorkFlow);
