<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramsPages.Master" AutoEventWireup="true" CodeBehind="VehicleMileageReport.aspx.cs" 
	Inherits="SCG.eAccounting.Web.Forms.SCG.eAccounting.Reports.VehicleMileageReport" EnableTheming="true" StylesheetTheme="Default" EnableEventValidation="false"   %>
<%@ Register src="~/UserControls/Report/VehicleMileageCriteria.ascx" tagname="VehicleMileageCriteria" tagprefix="uc1"%>
...
<%--<asp:UpdatePanel ID="ctlUpdatePanelCriteria" runat="server" UpdateMode="Conditional">
    <ContentTemplate>--%>
        <table width="100%" border=0>
            <tr>
                <td>
                    <uc1:VehicleMileageCriteria ID="ctlVehicleMileageCriteria" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
...
<table width="100%" style="height:700px" class="table">
        <tr>
            <td>
                <uc2:ReportViewers 
                        ID="VehicleMileage_Viewer" 
                        runat="server" 
                        ReportFolderPath="eAccountingReport" 
                        ReportName="VehicleMileageReport"                         
