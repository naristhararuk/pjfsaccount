...
{
    public partial class AnnouncementInfo : BasePage
    {
        ...
        private void GetNews(short languageId, short announcementGroupId)
        {
            ...
            IList<SuAnnouncementLang> announcementList = QueryProvider.SuAnnouncementLangQuery.FindAnnouncementByLangId(languageId,announcementGroupId);
        ...
        protected void rptAnnouncement_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (item.ItemType == ListItemType.Item || item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                string newWindowUrl = ResolveClientUrl("../Programs/AnnouncementPopup.aspx?announcementId=" + announcementLang.AnnouncementId + "&languageId=" + announcementLang.LanguageId);				
