...
{
    public partial class ManageUserProfile : BasePage
    {
        #region property
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(ParameterServices.EnableCheckboxNotifyRemindWaitApprove).ToLower() != "true")
            {
                ctlUserProfileGrid.Columns[4].Visible = false;
            }
        }
        #endregion
