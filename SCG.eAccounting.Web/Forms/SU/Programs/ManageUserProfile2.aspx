<%@ Page Title="" Language="C#" MasterPageFile="~/ProgramsPages.Master" AutoEventWireup="true"
    CodeBehind="ManageUserProfile2.aspx.cs" Inherits="SCG.eAccounting.Web.Forms.SU.Programs.ManageUserProfile2"
            ...
            <td align="left" style="width: 45%">
                <fieldset style="width: 90%" id="fdsSearch" class="table">
                    <table width="100%" border="0" class="table">
                        ...
                        <tr>
                            <td align="left" style="width: 40%">
                                <asp:Label ID="ctrEmployeeNameLabel" runat="server" Text="$EmployeeName$"></asp:Label>
                                <asp:Label ID="ctlColonEmployeeName" runat="server" Text=":"></asp:Label>
                            </td>
                            <td align="left" style="width: 60%">
            ...
            <ss:BaseGridView ID="ctlUserProfileGrid" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="User Id" HeaderStyle-Width="15%" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="ctlUserProfileCodeLabel" SkinID="SkGeneralLabel" runat="server"
                                Text='<%# Bind("UserName") %>' Mode="Encode" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Employee Name" HeaderStyle-Width="50%" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="ctlUserProfileNameLabel" SkinID="SkGeneralLabel" runat="server"
                                Text='<%# Bind("EmployeeName") %>' Mode="Encode" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Company" HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="ctlUserProfileCompanyLabel" SkinID="SkGeneralLabel" runat="server"
                                Mode="Encode" Text='<%# Bind("CompanyCode") %>' />
                        </ItemTemplate>
