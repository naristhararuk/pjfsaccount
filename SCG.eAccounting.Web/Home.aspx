<%@ Page Language="C#" MasterPageFile="~/LoginPage.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SCG.eAccounting.Web.Home" EnableTheming="true" StylesheetTheme="Default" %>
...
<%@ Register Src="UserControls/PanelMenu.ascx" TagName="PanelMenu" TagPrefix="uc5" %>

<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolderWelcomeMsg">
    <uc5:PanelMenu ID="PanelMenu" runat="server" />
</asp:Content>

<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolderService">
        ...
        <td>
            ...
            <tr>
                ...
                <td align="Left" valign="top"><br /><br />
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="ctlImageLine" ImageUrl="~/App_Themes/Default/images/line-welcome.png" runat="server" />
                        </td>
                        <td></td>
                    </tr>
                    <tr>
