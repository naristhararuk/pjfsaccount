<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CountryLookUp.ascx.cs" Inherits="SCG.eAccounting.Web.UserControls.LOV.SCG.DB.CountryLookUp" %>
...
<asp:Panel ID="pnCountrySearch" runat="server" Width="600px" BackColor="White">
    <asp:Panel ID="pnACountrySearchHeader" CssClass="table" runat="server" Style="cursor: move;border:solid 1px Gray;color:Black">
		<div>
    ...
    <asp:UpdatePanel ID="UpdatePanelGridView" runat="server" UpdateMode="Conditional">
            ...
            <center>
                ...
                <ss:BaseGridView ID="ctlCountryGrid" runat="server" AutoGenerateColumns="False"
                    OnRequestData="RequestData"  ReadOnly="true" EnableInsert="false" EnableViewState="true"
                    DataKeyNames="CountryID" CssClass="table"
                    OnDataBound="ctlCountryGrid_DataBound" Width="99%" 
                    onrowcommand="ctlCountryGrid_RowCommand">
                    <Columns>
                    ...
                    <asp:TemplateField ShowHeader="false">
                        <ItemTemplate>
                             <asp:ImageButton ID="ctlReceiptTypeSelect" runat="server" SkinID="SkCtlGridSelect"  CausesValidation="False" CommandName="Select" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
