<%@ Page Title="" Language="C#" MasterPageFile="~/PopupMasterPage.Master" AutoEventWireup="true" CodeBehind="MPADocumentLookup.aspx.cs" Inherits="SCG.eAccounting.Web.UserControls.LOV.SCG.eAccounting.MPADocumentLookup" StylesheetTheme="Default"  %>
<%@ Register Src="MPADocumentLookup.ascx" TagName="MPALookup" TagPrefix="uc1" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelGridView" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <center>
                                    ...
                                    <ss:BaseGridView ID="ctlMPALookupGrid" EnableViewState="true" Width="99%" runat="server"
                                        DataKeyNames="MPADocumentID" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false"
                                        OnRowCommand="ctlMPALookupGrid_RowCommand" OnDataBound="ctlMPALookupGrid_DataBound"
