<%@ Control 
    ...
    EnableTheming = "true"
    CodeBehind="ProvinceLookUp.ascx.cs" 
    Inherits="SCG.eAccounting.Web.UserControls.LOV.SS.DB.ProvinceLookUp" 
%>
	    ...
	    <asp:UpdatePanel ID="UpdatePanelGridView" runat="server" UpdateMode="Conditional">
            ...
            <center>
                ...
                <ss:BaseGridView 
                    ...
                    EnableInsert="false"    ReadOnly="true" AllowSorting="true"         AllowPaging="True"          CssClass="table" 
                    ID                  = "ctlGridProvince" 
