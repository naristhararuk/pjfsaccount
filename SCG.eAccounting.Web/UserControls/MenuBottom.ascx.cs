...
{
    public partial class MenuBottom : BaseUserControl
    {
        ...
        //        {
        //            if (ctlContentID.Text == "18" || ctlContent.Text.ToUpper() == "HOME" || ctlContent.Text == "หน้าหลัก")
        //                newWindowUrl = "../Home.aspx";
        //            else
        //                newWindowUrl = "../Home.aspx?nodeId=" + ctlContentID.Text + "&languageId=" + UserAccount.CurrentLanguageID.ToString();
        //        }
        //        else
        //        {
        //            if (ctlContentID.Text == "18" || ctlContent.Text.ToUpper() == "HOME" || ctlContent.Text == "หน้าหลัก")
        //                newWindowUrl = "../Login.aspx";
        //            else
        //                newWindowUrl = "../Login.aspx?nodeId=" + ctlContentID.Text + "&languageId=" + UserAccount.CurrentLanguageID.ToString();
        //        }
