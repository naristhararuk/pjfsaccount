<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenuBottomLogin.ascx.cs" Inherits="SCG.eAccounting.Web.UserControls.MenuButtomLogin" EnableTheming ="true"%>
...
<tr>
    <td>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0;padding:0;" >
        <tr>
            <td align="left" style="width:12px"><div id="imgFooterLeft" runat="server" class="FooterLeftLogin"></div></td>
            <td class="FooterLineLogin" align="left" valign="middle">
            ...
            <td align="left" style="width:12px"><div id="imgFooterRight" runat="server" class="FooterRightLogin"></div></td>
        </tr>
        </table>
    </td>
</tr>
