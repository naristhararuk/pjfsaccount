<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MileageEmp2.ascx.cs"
    Inherits="SCG.eAccounting.Web.UserControls.MileageEmp2" %>
        ...
        <HeaderTemplate>
                <table border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center" style="width:15%">1-100 km.</td>
                        <td align="center" style="width:20%">Exceeding 100 km.</td>
                    </tr>
                </table>
            </HeaderTemplate>
            <ItemTemplate>
                <table border="0" width="100%">
                    <tr>
                        ...
                        <td align="right" style="width:15%"><%# Eval("Distance") %></td>
                        <td align="right" style="width:20%"><%# Eval("Exceeding")%></td>
                    </tr>
                </table>
            </ItemTemplate>
            <FooterTemplate>
                <table width="100%">
                    <tr>
                        <td align="right" style="width:15%">200</td>
                        <td align="right" style="width:15%">190</td>
