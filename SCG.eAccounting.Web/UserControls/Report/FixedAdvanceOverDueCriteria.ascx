<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FixedAdvanceOverDueCriteria.ascx.cs" Inherits="SCG.eAccounting.Web.UserControls.Report.FixedAdvanceOverDueCriteria" EnableTheming="true"%>
...
<asp:UpdatePanel ID="UpdatePanelVendor" runat="server" UpdateMode="Conditional">
    ...
    <table class="table" width="600px" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <asp:Label ID="ctlFromFixedAdvanceAmountText" runat="server" Text="$FixedAdvance Amount$" SkinID="SkFieldCaptionLabel"></asp:Label>
            </td>
            <td>
                 <asp:TextBox ID="ctlFromFixedAdvanceAmount" runat="server" SkinID="SkNumberTextBox"></asp:TextBox>
            </td>
            <td>
                <asp:Label ID="ctlToFixedAdvanceAmountText" runat="server" Text="$To$" SkinID="SkFieldCaptionLabel"></asp:Label>
            </td>
             <td>
                 <asp:TextBox ID="ctlToFixedAdvanceAmount" runat="server" SkinID="SkNumberTextBox"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="ctlFixedAdvanceTypeText" runat="server" Text="$FixedAdvance Type$" SkinID="SkFieldCaptionLabel"></asp:Label>
            </td>
            <td colspan="3">
                <asp:DropDownList ID="ctlFixedAdvanceType" runat="server" SkinID="SkGeneralDropdown">
