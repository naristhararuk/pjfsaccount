...
{
    public partial class ShowDateTime : BaseUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (UserAccount.CurrentLanguageID == 1)
                {
                    ...
                    lblTime.Text = SetTimeThai();
                }
                else if (UserAccount.CurrentLanguageID == 2)
                {
                    lblDate.Text = SetDateEng();
                    lblTime.Text = SetTimeEng();
                }
            }
        }

        public string SetDateThai()
        {
