<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvanceWorkflowMonitor.ascx.cs"
    Inherits="SCG.eAccounting.Web.UserControls.WorkFlow.AdvanceWorkflowMonitor" %>
