...
{
    public partial class ApproveReason : SS.Standard.UI.BaseUserControl, IEventControl
    {
        ...
        public void BindReasonDropdown()
        {
            ...
            if (ctlReasonDdl.Items.Count > 0)
            {
                ctlReasonDdl.Items.Insert(0, new ListItem(GetMessage("NotSpecify"), string.Empty));
            }
        }
        #endregion
    }
