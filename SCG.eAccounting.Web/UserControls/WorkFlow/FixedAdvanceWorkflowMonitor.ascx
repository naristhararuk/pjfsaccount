<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FixedAdvanceWorkflowMonitor.ascx.cs"
    Inherits="SCG.eAccounting.Web.UserControls.WorkFlow.FixedAdvanceWorkflowMonitor" %>
