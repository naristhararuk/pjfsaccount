...
<script runat="server">
	...
	{
        string uploadPath = SS.DB.Query.ParameterServices.AnnouncementUploadFilePath;   //Comment by Desh 21-Jan-09 not use like this anymore = SS.SU.Query.QueryProvider.DbParameterQuery.getParameterByGroupNo_SeqNo("1", "12");
        ...
        TypeConfig["File"].AllowedExtensions = new string[] { "7z", "zip" ,"gzip", "aiff", "asf", "tar", "tgz", "gz", "odt", "pxd", "qt", "ram", "rar", //Compress File   
                                                            "fla", "flv", "swf", "sxw", // Flash
                                                            "gif", "jpeg", "jpg", "png", "bmp", "tif", "tiff", // Picture
                                                            "wma", "wmv", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "avi", "wav", //Multi Media
                                                            "rm", "rmi", "rmvb", "rtf", "sdc", "sitd",  "sxc",                                   //Multi Media
                                                            "doc", "xls", "ppt", "csv", "xml", // Office 2003
                                                            "docx", "xlsx" , "pptx",           //Office 2007
                                                            "pdf", "txt", "vsd", "st"};        //Other Document File type
		...
		TypeConfig[ "Image" ].AllowedExtensions			= new string[] { "bmp", "gif", "jpeg", "jpg", "png" ,"tif","tiff"};
