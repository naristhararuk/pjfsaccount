...
FCKConfig.ToolbarSets["Custom"] = [
	['Bold', 'Italic', 'Underline', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyFull', '-', 'OrderedList', 'UnorderedList', 'TextColor', 'BGColor', '-', 'Image', 'Link', '-', 'Source'],
	['FontName', 'Style', 'FontSize', 'RemoveFormat','-', 'Smiley', 'SpecialChar', 'Table']
];
...
FCKConfig.FontNames     = 'Arial;Angsana New;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana;';
