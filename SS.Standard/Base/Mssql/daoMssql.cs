...
{
    public class daoMssql<T> : baseMssqlDAL 
    {
        ...
        public daoMssql(string Table, string[] Coloumn, int numPK, bool AutoIncrement)
        {
            this.Table = Table;
        ...
        public void UpdateDetail(absMssqlDTO Obj)
        {
        ...
        public void CreateDetail(absMssqlDTO Obj)
        {
            Obj.UPD_BY = UserAccount.UserID;
            Obj.UPD_DATE = DateTime.Now; ;
            Obj.UPD_PGM = this.PgmName;
